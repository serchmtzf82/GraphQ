...
const contractABI = require("../artifacts/contracts/Graphqledge.sol/Graphqledge.json").abi;

program
    .name("graphqledge-cli")
    .description("CLI tool for Graphqledge smart contract")
    .version("1.0.0");
